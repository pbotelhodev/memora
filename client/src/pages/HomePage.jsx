      ...
      <main>
        ...
        <section className="showcase">
          <div className="container-showcase">
            ...
            <div className="showcase-subtitle">
              <p>
                A sua festa pelos olhos de todos. Uma galeria viva, colaborativa
                e atualizada em tempo real na palma da mão dos seus convidados.
              </p>
            </div>
        ...
        <section className="steps-section">
          ...
          <div className="steps-container">
            <CardHowUse
              icon={<Camera size={50} color={"white"} />}
            ...
            />
            <CardHowUse
              icon={<QrCode size={50} color={"white"} />}
            ...
            />
            <CardHowUse
              icon={<Share2 size={50} color={"white"} />}
              title={"3. Compartilhe"}
              subtitle={
