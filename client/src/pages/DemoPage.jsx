...
import { Camera, MonitorPlay, QrCode } from "lucide-react";
...
const DemoPage = () => {
  return (
    <div className="demo-container">
      ...
      {/* 2. MOCKUPS CELULARES (Sem Notch) */}
      <section className="demo-phones-section">
        <div className="phones-grid">
          {/* Celular 1 */}
          <div className="phone-mockup">
            <img src={printCelular1} alt="Feed" />
          </div>
          {/* Celular 2 (Destaque Central) */}
          <div className="phone-mockup center">
            <img src={printCelular2} alt="Câmera" />
          </div>
          {/* Celular 3 */}
          <div className="phone-mockup">
            <img src={printCelular3} alt="Perfil" />
          </div>
        </div>
      </section>
        ...
        <div className="tv-container">
          ...
          <div className="tv-frame">
            <div className="tv-screen">
              <img src={printTelao} alt="Telão do Evento" />
            </div>
